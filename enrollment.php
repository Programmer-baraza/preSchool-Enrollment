...
<select class="form-control" id="erollprogram" name="erollprogram"  required>
                        ...
                        <option value="junior primary- 5.0 t0 7.0 years">Juniour Primary- 5.0 to 7.0 years</option>
                        <option value="junior Secondary- 8.5 to 11 years">Junior  Secondary- 8.5 to 11 years</option>
